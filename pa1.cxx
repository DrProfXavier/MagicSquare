...
//Base print array method
void printArr(int *arr, int size, int num)//magicSquare call by reference 
	{
...
{
  int n;
  cout<< "Enter the size of a magic square from 3-15: ";
  cin>>n;
  if ((n > 15) || (n < 3)) 
	{
		cin.clear();
		cin.ignore();
		cout << "Not a valid number. Please re-enter or program will terminate: ";
		cin >> n;	
